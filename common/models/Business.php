...
class Business extends ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            ...
            [['notify_confirmation', 'notify_reminder'], 'boolean'],
            [['notify_confirmation', 'notify_reminder'], 'default', 'value' => true],
            // 1..168 hours: anything outside that is a mis-typed field, not a plan.
            [['reminder_hours'], 'integer', 'min' => 1, 'max' => 168],
            [['reminder_hours'], 'default', 'value' => 24],
    ...
    public function attributeLabels(): array
    {
        return [
            ...
            'notify_confirmation' => 'Yozilganda tasdiq xabari',
            'notify_reminder' => 'Tashrifdan oldin eslatma',
            'reminder_hours' => 'Necha soat oldin',
