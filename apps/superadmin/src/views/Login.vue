...
async function submit() {
  ...
  try {
    ...
    if (!auth.isSuperadmin) {
      auth.logout(false)
      error.value = 'Bu panel faqat superadmin uchun.'
      return
    }
    router.push('/')
  } catch (e) {
...
<template>
  <div class="auth">
    <div class="auth-card card">
      <div class="auth-brand">🛡️ TizBiz <span class="tag" style="color: var(--brand)">Superadmin</span></div>
      <p class="muted" style="margin: 0 0 20px">Platforma boshqaruvi</p>
